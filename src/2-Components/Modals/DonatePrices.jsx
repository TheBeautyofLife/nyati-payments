          ...
          <div className="bg-white min-h-[60vh] w-full flex flex-col py-8 sm:py-16 max-w-[90%] px-5 sm:max-w-[540px] sm:px-16 gap-[20px] relative mx-auto">
            ...
            <div className="flex flex-col gap-[10px]">
              ...
              <div className="flex flex-col gap-[10px]">
                ...
                >
                  Continue with Automatic MTN Momo
                </Buttons>
                {/** 
                 <Buttons
                  className=" w-full  rounded-full font-[Roboto-Medium] text-sm sm:text-base"
                ...
                >
                  Continue with Visa & Other Payment Options
                </Buttons>

                {
                  /** //commented out Merchant Pay
                   * 
                   *  <Buttons
                  className=" w-full  rounded-full font-[Roboto-Medium] text-sm sm:text-base"
                  type="button"
                  onClick={() => handleSubmitted("MerchantPay", setFieldValue, errors)}
                >
                  Continue with Merchant Pay (MTN & Airtel)
                </Buttons>
                   * 
                   * 
                   * 
