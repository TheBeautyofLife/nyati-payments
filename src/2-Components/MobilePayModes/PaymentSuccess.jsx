      ...
      <div className="bg-[#FFFFFF] flex flex-col gap-[16px] max-w-[400px] py-8 px-5 sm:px-14">
          ...
          <div className="flex flex-col gap-[50px]">
              ...
              <div className="flex flex-row gap-[10px]">
                  <Buttons onClick={()=> navigate("/")} className="w-full rounded-full font-[Roboto-Medium] text-xs sm:text-base bg-transparent hover:bg-transparent border border-primary-500 text-primary-500 text-opacity-30 border-opacity-30 hover:border-opacity-100 hover:text-primary-500">
                      Close & Return
                  </Buttons>
              </div>
          </div>
