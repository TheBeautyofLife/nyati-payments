...
import Buttons from "../../2-Components/Buttons/Buttons.tsx";
...
const PaymentResponse = () => {
    ...
    let GetTransaction = async (Id) => {
        //console.log("id", Id)
        let getStatus = await axios.get(`${BASE_API}/payment/pesapal/tansact_statuses?OrderTrackingId=${Id}`, { headers: { "content-type": "application/json" } });
        ...
        <div className="bg-[#D7D5D5] min-h-[100vh] w-full flex flex-col items-center justify-center gap-[20px] relative">
            ...
            <div className="bg-[#FFFFFF] flex flex-col gap-[16px] max-w-[400px] py-8 px-5 sm:px-14">
                <div className="flex w-full flex-col gap-[10px] sm:gap-[16px] items-center">
                    <div className={`w-[57px] h-[57px] lg:w-[57px] lg:h-[57px] relative flex rounded-full ${responseData !== null && responseData.payment_status_description.includes("failed") ? 'bg-[#ED0E3B]' : "bg-[#21BE79]"} p-3`}>
                    ...
                    <div className="font-[Inter-Medium] text-base md:text-base lg:text-3xl text-center  text-[#141118]">
                        <p>Donation Payment ${responseData !== null && responseData.payment_status_description.includes("failed") ? 'Failed' : "Successful"} </p>
                ...
                <div className="flex flex-col gap-[50px]">
                    <div className="flex flex-col gap-[10px]">
                        <div className="py-[30px] px-4 bg-[#F5F4F5] text-[#8B8789]">
                            ...
                            <p className="font-[Inter-SemiBold] text-[15px] ">
                                Payment Status : {responseData !== null && responseData.payment_status_description ? responseData.payment_status_description : ""}
                            </p>
                        </div>
